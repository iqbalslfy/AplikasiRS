...
public class LayananLasik extends AppCompatActivity implements View.OnClickListener {
    ...
    String namaDokter, hari, tanggal, waktu;
    Button btnBoking;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layanan_lasik);
    ...
    private void DialogForm() {
        ...
        View dialogView;
        dialog = new AlertDialog.Builder(LayananLasik.this);
