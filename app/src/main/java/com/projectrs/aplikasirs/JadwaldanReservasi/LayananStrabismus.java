...
public class LayananStrabismus extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layanan_strabismus);
    ...
    private void DialogForm() {
        ...
        View dialogView;
        dialog = new AlertDialog.Builder(LayananStrabismus.this);
