...
public class LayananLensaKontak extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layanan_lensa_kontak);
    ...
    private void DialogForm() {
        ...
        View dialogView;
        dialog = new AlertDialog.Builder(LayananLensaKontak.this);
