...
public class LayananRetina extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layanan_retina);
    ...
    private void DialogForm() {
        ...
        View dialogView;
        dialog = new AlertDialog.Builder(LayananRetina.this);
