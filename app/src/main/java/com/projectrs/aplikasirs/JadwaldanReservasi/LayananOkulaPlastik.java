...
public class LayananOkulaPlastik extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layanan_okula_plastik);
    ...
    private void DialogForm() {
        ...
        View dialogView;
        dialog = new AlertDialog.Builder(LayananOkulaPlastik.this);
